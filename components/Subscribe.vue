            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mailchimp-one__content">
                        ...
                        <h2 class="mailchimp-one__title">Inscrivez-vous à<br>
                            notre newsletter</h2><!-- /.mailchimp-one__title -->
                    </div><!-- /.mailchimp-one__content -->
                </div><!-- /.col-lg-6 -->
                <div class="col-lg-6 d-flex">
                    <div class="my-auto">
                        <form action="#" class="mailchimp-one__form mc-form">
                            <input type="text" id="mc-email" placeholder="Entrez votre email ">
                            <button type="submit" class="thm-btn">S'Abonner</button>
